...
@section('content')
    <div class="card">
        <div class="card-header" id="reloadContent">
            ...
            <div class="d-flex ml-auto">
                ...
                @if ($data['can_go_live'] == 2)
                    <h2 class='btn btn-danger ml-2 restrict-live' rel='{{ $data->id }}'>{{ __('app.Restrict_live') }}
                    </h2>
                @else
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item " role="presentation">
                <button class="nav-link active" id="allUserPostsTab" data-bs-toggle="tab"
                    ...
                    aria-controls="allUserPostsTab-panel" aria-selected="true"> {{ __('app.posts') }} </button>
            </li>
            <li class="nav-item " role="presentation">
                <button class="nav-link" id="userStoryTab" data-bs-toggle="tab" data-bs-target="#userStoryTab-pane"
                    type="button" role="tab" aria-controls="userStoryTab-panel" aria-selected="true">
                    {{ __('app.stories') }} </button>
            </li>
        </ul>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group position-relative m-0">
                        ...
                        <img src="" alt="" srcset="" id="story_content"
                            class="img-fluid story_content_view">
                    </div>
                </div>
    ...
    <!-- View Story Modal -->
    <div class="modal fade" id="viewStoryVideoModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="viewPostDescModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
