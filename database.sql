...
--
-- Host: localhost:3306
-- Generation Time: Jun 27, 2024 at 11:47 AM
...
INSERT INTO `appdata` (`id`, `currency`, `min_threshold`, `coin_rate`, `min_user_live`, `max_minute_live`, `message_price`, `reverse_swipe_price`, `live_watching_price`, `admob_int_ios`, `admob_banner_ios`, `admob_int`, `admob_banner`, `is_dating`, `is_social_media`, `post_description_limit`, `post_upload_image_limit`, `created_at`, `updated_at`) VALUES
(1, '$', 5000, '0.006', 55, 50, 5, 6, 10, 'int ios', 'ban ios', 'int and', 'Bann and', 1, 1, 200, 4, '2024-06-13 13:29:16', '2024-06-13 13:29:16');
...
CREATE TABLE `live_application` (
  ...
  `social_links` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `posts` (
  ...
  `interest_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comments_count` int DEFAULT '0',
  `likes_count` int DEFAULT '0',
  `hashtags` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `likedprofile` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
