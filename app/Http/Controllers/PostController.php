...
class PostController extends Controller
{
        ...
        if ($user) {
            ...
            if ($post) {
                ...
                if ($user->id != $post->user_id) {
                    ...
                    $userNotification->post_id = (int) $request->post_id;
    ...
    public function deleteComment(Request $request)
    {
        ...
        if($comment) {
            ...
            $deleteCommentFromUserNotification = UserNotification::where('user_id', $request->user_id)
    ...
    public function dislikePost(Request $request)
    {
        ...
        if ($user) {
            ...
            if ($likedPost) {
                ...
                $userNotification = UserNotification::where('post_id', $request->post_id)->where('user_id', $request->user_id)->first();
                if($userNotification) {
